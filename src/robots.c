...
static ROBOT    robotStart[20][8] =
{
    ...
    },
    {
        ...
        {5, 1, 5, 104, DoRobotDown, DoRobotDraw, DoNothing, 3, 27, 0x7, 3, 0, 0},
        {10, 1, 5, 104, DoRobotDown, DoRobotDraw, DoNothing, 2, 27, 0xc, 3, 1, 0},
        {20, 1, 5, 104, DoRobotDown, DoRobotDraw, DoNothing, 4, 27, 0x9, 3, 2, 0},
        {25, 1, 5, 104, DoRobotDown, DoRobotDraw, DoNothing, 1, 27, 0xe, 3, 3, 0}
    },
    {
...
{
    robotStart[16][2].gfx = 25 + version;
    robotStart[16][3].gfx = 25 + version;
    robotStart[16][4].gfx = 25 + version;
    robotStart[16][5].gfx = 25 + version;
    robotStart[17][4].gfx = 27 + version;
    robotStart[17][5].gfx = 27 + version;
    robotStart[17][6].gfx = 27 + version;
    robotStart[17][7].gfx = 27 + version;
}
